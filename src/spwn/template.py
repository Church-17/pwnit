...
class Template:
	...
	def create_script(self,
		...
		replacements = {
			...
			EXE_RELPATH: str(exe.path.relative_to(Path.cwd(), walk_up=True)) if exe else "EXE_RELPATH",
			...
			EXE_DEBUG_RELPATH: str(exe.debug_path.relative_to(Path.cwd(), walk_up=True)) if exe else "EXE_DEBUG_RELPATH",
			...
			LIBC_RELPATH: str(libc.path.relative_to(Path.cwd(), walk_up=True)) if libc else "LIBC_RELPATH",
			...
			LIBC_DEBUG_RELPATH: str(libc.debug_path.relative_to(Path.cwd(), walk_up=True)) if libc else "LIBC_DEBUG_RELPATH",
